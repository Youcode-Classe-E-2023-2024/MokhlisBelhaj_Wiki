    ...
    <div class="grid grid-cols-1 p-4 bg-gray-50 overflow-x-auto gab-3 border border-gray-100 rounded-lg mb-2">
        ...
        <table class="w-full text-center">
            <thead class="bg-gray-100 rounded-sm">
                <tr>
                    <th class="border border-1 text-center">title</th>
                    <th class="border border-1 text-center">image</th>
                    <th class="border border-1 text-center">content</th>
                    <th class="border border-1 text-center">category</th>
                    <th class="border border-1 text-center">tags</th>
                    <th class="border border-1 text-center">create_at</th>
                    <th class="border border-1 text-center">edit_at</th>
                    <th class="border border-1 text-center">Status</th>
                    <th colspan="2" class="border border-1 text-center">Action</th>
                </tr>
            </thead>
                ...
                <div id="newinp" class="mx-auto w-full max-w-[550px]">
                        ...
                        <div class="w-full px-3">
                         ...
                         cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700
                          dark:border-gray-600 dark:placeholder-gray-400" name="image" id="large_size" type="file">
                            <span id="image_err" class="text-red-500 text-sm"></span>
                        </div>
                        <div class="mb-5">
                            <label for="title" class="mb-3 block text-base font-medium text-[#07074D]">
                                title
                            </label>
                            <input type="text" id="title" name="title" placeholder="title" class="w-full h-14 rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                            <span id="title_err" class="text-red-500 text-sm"></span>
                    ...
                    <div class="w-full px-3">
                        <div class="mb-5">
                            ...
                            <input type="text" id='content' name="content" placeholder="content" class="w-full h-14 rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                            <span id="content_err" class="text-red-500 text-sm"></span>
                        </div>
                    </div>
                    <div class="w-full px-3">
                        <div class="mb-5">
                    ...
                    <div class="w-full px-3">
                        <div class="mb-5">
                            <div class="relative w-full px-3 my-8">
                                ...
                                <span id="tag_err" class="text-red-500 text-sm"></span>
...
<div id="ArticleEditeModal" class="hidden fixed inset-0 z-10 overflow-y-auto   backdrop-blur-lg flex items-center justify-center transition-transform duration-300">
    <div class="modal-container overflow-y-auto h-fit p-6 backdrop-blur-sm bg-white/90 w-11/12 sm:w-11/12 md:w-8/12 lg:w-6/12 rounded-md shadow-sm">
        <h2 class="text-2xl font-semibold mb-6">Create New Article</h2>
        <form id="articleEditeForm" action="<?= URLROOT ?>Author/addArticle" method="post" class="Article-form" enctype="multipart/form-data">
            <div class="flex items-center justify-center p-12">
                <div class="mx-auto w-full max-w-[550px]">
                    <div class="mx-3">
                        <div class="w-full px-3">
                            ...
                            <input class="block w-full text-lg text-gray-900 border border-gray-300 rounded-lg
                         cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700
                          dark:border-gray-600 dark:placeholder-gray-400" name="image" id="Editelarge_size" type="file">
                        </div>
                        <div class="mb-5">
                            <label for="title" class="mb-3 block text-base font-medium text-[#07074D]">
                                title
                            </label>
                            <input type="text" id="titleEdite" name="title" placeholder="title" class="w-full h-14 rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
